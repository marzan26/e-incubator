...
class TempHistoryCard extends StatelessWidget {
  final String day;
  const TempHistoryCard({
    Key? key,
    required this.day,
  }) : super(key: key);
    ...
    return Stack(
        children: [
          ...
          Positioned(
              ...
              child: Container(
                child: Text(
                  "Bulb First Turned On: 0400 Hours",
                  style: GoogleFonts.lato(
                    fontSize: 15,
                    color: Colors.black,
                  ),
          ...
          Positioned(
              ...
              child: Container(
                child: Text(
                  "Bulb Second Turned On: 1200 Hours",
                  style: GoogleFonts.lato(
                    fontSize: 15,
                    color: Colors.black,
                  ),
          ...
          Positioned(
              ...
              child: Container(
                child: Text(
                  "Bulb Third Turned On: 1800 Hours",
                  style: GoogleFonts.lato(
                    fontSize: 15,
                    color: Colors.black,
                  ),
