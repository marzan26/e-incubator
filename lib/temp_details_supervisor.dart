...
class TempDetails1 extends StatefulWidget {
  const TempDetails1({Key? key}) : super(key: key);

  @override
  State<TempDetails1> createState() => _TempDetails1State();
}

class _TempDetails1State extends State<TempDetails1> {
