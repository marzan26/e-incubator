...
class TurnHistory1 extends StatelessWidget {
  const TurnHistory1({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          Expanded(
            ...
            child: ListView(
              children: [
                EggTurnCard(day: "Day 1"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 2"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 3"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 4"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 5"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 6"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 7"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 8"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 9"),
                SizedBox(height: height*0.02,),
                EggTurnCard(day: "Day 10"),
                SizedBox(height: height*0.02,),
              ],
             ),
            )
