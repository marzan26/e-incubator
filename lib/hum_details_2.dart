...
import 'duty_staff_1.dart';

class HumDetails2 extends StatefulWidget {
  const HumDetails2({Key? key}) : super(key: key);

  @override
  State<HumDetails2> createState() => _HumDetails2State();
}

class _HumDetails2State extends State<HumDetails2> {
  ...
  Future openDialog1(context) => showDialog(
    context: context,
      ...
      child: AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
              children: [
                Text(
                    "What Do You Want To Do With The Humidifier?"
                )
              ]
          ),
        ),
